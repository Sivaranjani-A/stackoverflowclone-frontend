                        ...
                        <div className="card-body p-0">
                            ...
                            <div className="row">
                                <div className="col-lg-6 d-none d-lg-block h-100vh bg-login-image">
                                    <img class="card-img-top" src="https://w7.pngwing.com/pngs/93/798/png-transparent-paperwork-stack-office-papers-business-paper-work-stack-overflow-logo-thumbnail.png" alt="Card image cap" />
                                </div>
